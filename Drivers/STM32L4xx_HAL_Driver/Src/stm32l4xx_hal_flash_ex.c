...
static HAL_StatusTypeDef FLASH_OB_WRPConfig(uint32_t WRPArea, uint32_t WRPStartOffset,
                                            uint32_t WRDPEndOffset);
static HAL_StatusTypeDef FLASH_OB_RDPConfig(uint32_t RDPLevel);
static HAL_StatusTypeDef FLASH_OB_UserConfig(uint32_t UserType, uint32_t UserConfig);
static HAL_StatusTypeDef FLASH_OB_PCROPConfig(uint32_t PCROPConfig, uint32_t PCROPStartAddr,
...
HAL_StatusTypeDef HAL_FLASHEx_OBProgram(FLASH_OBProgramInitTypeDef * pOBInit) {
    ...
    if ((pOBInit->OptionType & OPTIONBYTE_WRP) != 0U) {
        ...
        if (FLASH_OB_WRPConfig(pOBInit->WRPArea, pOBInit->WRPStartOffset, pOBInit->WRPEndOffset) !=
            HAL_OK) {
            status = HAL_ERROR;
        }
    }
 ...
 *            @arg OB_WRPAREA_BANK2_AREAA: Flash Bank 2 Area A  (don't apply for STM32L43x/STM32L44x
 * devices)
 *            @arg OB_WRPAREA_BANK2_AREAB: Flash Bank 2 Area B  (don't apply for STM32L43x/STM32L44x
 * devices)
 *
 ...
 *            @arg OB_WRPAREA_BANK1_AREAA: Flash Bank 1 Area A
 *            @arg OB_WRPAREA_BANK1_AREAB: Flash Bank 1 Area B
 *            @arg OB_WRPAREA_BANK2_AREAA: Flash Bank 2 Area A (don't apply to STM32L43x/STM32L44x
 * devices)
 *            @arg OB_WRPAREA_BANK2_AREAB: Flash Bank 2 Area B (don't apply to STM32L43x/STM32L44x
 * devices)
 *
 ...
 * @brief  Return the FLASH Write Protection Option Bytes value.
 *
 * @param PCROPConfig [inout]: specifies the configuration (Bank to be configured and PCROP_RDP
 * option). This parameter must be a combination of FLASH_BANK_1 or FLASH_BANK_2 with
 * OB_PCROP_RDP_NOT_ERASE or OB_PCROP_RDP_ERASE
 *
