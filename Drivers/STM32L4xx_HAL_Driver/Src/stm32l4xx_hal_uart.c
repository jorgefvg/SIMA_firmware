...
#define USART_CR1_FIELDS                                                                           \
    ((uint32_t)(USART_CR1_M | USART_CR1_PCE | USART_CR1_PS | USART_CR1_TE | USART_CR1_RE |         \
                USART_CR1_OVER8 | USART_CR1_FIFOEN)) /*!< UART or USART CR1 fields of parameters   \
                                                        set by UART_SetConfig API */
#else
#define USART_CR1_FIELDS                                                                           \
    ((uint32_t)(USART_CR1_M | USART_CR1_PCE | USART_CR1_PS | USART_CR1_TE | USART_CR1_RE |         \
                USART_CR1_OVER8)) /*!< UART or USART CR1 fields of parameters set by               \
                                     UART_SetConfig API */
...
HAL_HalfDuplex_Init(),
  *         HAL_LIN_Init(), HAL_MultiProcessor_Init() or HAL_RS485Ex_Init() in HAL_UART_STATE_RESET
to register
