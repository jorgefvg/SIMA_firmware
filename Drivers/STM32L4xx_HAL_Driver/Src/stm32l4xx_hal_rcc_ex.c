...
/**
  ...
  *         contains a field PeriphClockSelection which can be a combination of the following
  values:
  ...
  *            @arg @ref RCC_PERIPHCLK_UART5  USART1 peripheral clock (only for devices with UART5)
  *            @arg @ref RCC_PERIPHCLK_USB  USB peripheral clock (only for devices with USB)
  *            @arg @ref RCC_PERIPHCLK_DFSDM1  DFSDM1 peripheral kernel clock (only for devices with
  DFSDM1)
  *            @arg @ref RCC_PERIPHCLK_DFSDM1AUDIO  DFSDM1 peripheral audio clock (only for devices
  with DFSDM1)
  ...
  *            @arg @ref RCC_PERIPHCLK_OSPI  OctoSPI peripheral clock (only for devices with
  OctoSPI)
  @endif
  *
...
HAL_StatusTypeDef HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef * PeriphClkInit) {
    ...
    if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI1) == RCC_PERIPHCLK_SAI1)) {
        ...
        case RCC_SAI1CLKSOURCE_PLLSAI1: /* PLLSAI1 is used as clock source for SAI1*/
            /* PLLSAI1 input clock, parameters M, N & P configuration and clock output
             * (PLLSAI1ClockOut) */
    ...
    if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI2) == RCC_PERIPHCLK_SAI2)) {
        ...
        case RCC_SAI2CLKSOURCE_PLLSAI2: /* PLLSAI2 is used as clock source for SAI2*/
            /* PLLSAI2 input clock, parameters M, N & P configuration and clock output
             * (PLLSAI2ClockOut) */
            ret = RCCEx_PLLSAI2_Config(&(PeriphClkInit->PLLSAI2), DIVIDER_P_UPDATE);
            /* SAI2 clock source config set later after clock selection check */
            break;
    ...
    if ((PeriphClkInit->PeriphClockSelection & RCC_PERIPHCLK_RTC) == RCC_PERIPHCLK_RTC) {
        ...
        if (ret == HAL_OK) {
            /* Reset the Backup domain only if the RTC Clock source selection is modified from
             * default */
    ...
    if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_USB) == (RCC_PERIPHCLK_USB)) {
        ...
        if (PeriphClkInit->UsbClockSelection == RCC_USBCLKSOURCE_PLL) {
            ...
            if (PeriphClkInit->UsbClockSelection == RCC_USBCLKSOURCE_PLLSAI1) {
                /* PLLSAI1 input clock, parameters M, N & Q configuration and clock output
                 * (PLLSAI1ClockOut) */
    ...
    if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_ADC) == RCC_PERIPHCLK_ADC) {
        ...
        if (PeriphClkInit->AdcClockSelection == RCC_ADCCLKSOURCE_PLLSAI1) {
            /* PLLSAI1 input clock, parameters M, N & R configuration and clock output
             * (PLLSAI1ClockOut) */
    ...
    defined(STM32L485xx) || defined(STM32L486xx) || defined(STM32L496xx) || defined(STM32L4A6xx)
            ...
            /* PLLSAI2 input clock, parameters M, N & R configuration and clock output
             * (PLLSAI2ClockOut) */
    ...
    if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_DSI) == RCC_PERIPHCLK_DSI) {
        ...
        if (PeriphClkInit->DsiClockSelection == RCC_DSICLKSOURCE_PLLSAI2) {
            /* PLLSAI2 input clock, parameters M, N & Q configuration and clock output
             * (PLLSAI2ClockOut) */
...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef * PeriphClkInit) {
    ...
    PeriphClkInit->PeriphClockSelection =
        ...
        RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_USB | RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_RTC;
    ...
    PeriphClkInit->PeriphClockSelection =
        RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 | RCC_PERIPHCLK_LPUART1 |
        RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 | RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_LPTIM1 |
        RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_SAI1 | RCC_PERIPHCLK_SDMMC1 | RCC_PERIPHCLK_RNG |
    ...
    PeriphClkInit->PeriphClockSelection =
        ...
        RCC_PERIPHCLK_USB | RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_ADC | RCC_PERIPHCLK_SWPMI1 |
        RCC_PERIPHCLK_RTC;
    ...
    PeriphClkInit->PeriphClockSelection =
        RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 | RCC_PERIPHCLK_LPUART1 |
        RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 | RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_LPTIM1 |
        RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_SAI1 | RCC_PERIPHCLK_USB | RCC_PERIPHCLK_SDMMC1 |
    ...
    PeriphClkInit->PeriphClockSelection =
        ...
        RCC_PERIPHCLK_LPUART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 | RCC_PERIPHCLK_I2C3 |
        RCC_PERIPHCLK_I2C4 | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_SAI1 |
        RCC_PERIPHCLK_USB | RCC_PERIPHCLK_SDMMC1 | RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_ADC |
    ...
    PeriphClkInit->PeriphClockSelection =
        ...
        RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_SAI1 |
        RCC_PERIPHCLK_SAI2 | RCC_PERIPHCLK_SDMMC1 | RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_ADC |
    ...
    PeriphClkInit->PeriphClockSelection =
        ...
        RCC_PERIPHCLK_UART5 | RCC_PERIPHCLK_LPUART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 |
        RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_SAI1 |
        RCC_PERIPHCLK_SAI2 | RCC_PERIPHCLK_USB | RCC_PERIPHCLK_SDMMC1 | RCC_PERIPHCLK_RNG |
    ...
    PeriphClkInit->PeriphClockSelection =
        ...
        RCC_PERIPHCLK_SAI1 | RCC_PERIPHCLK_SAI2 | RCC_PERIPHCLK_USB | RCC_PERIPHCLK_SDMMC1 |
        RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_ADC | RCC_PERIPHCLK_SWPMI1 | RCC_PERIPHCLK_DFSDM1 |
        RCC_PERIPHCLK_RTC;
    ...
    PeriphClkInit->PeriphClockSelection =
        ...
        RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_I2C4 | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 |
        RCC_PERIPHCLK_SAI1 | RCC_PERIPHCLK_SAI2 | RCC_PERIPHCLK_USB | RCC_PERIPHCLK_SDMMC1 |
        RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_ADC | RCC_PERIPHCLK_DFSDM1 | RCC_PERIPHCLK_DFSDM1AUDIO |
    ...
    PeriphClkInit->PeriphClockSelection =
        ...
        RCC_PERIPHCLK_SAI1 | RCC_PERIPHCLK_SAI2 | RCC_PERIPHCLK_USB | RCC_PERIPHCLK_SDMMC1 |
        RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_ADC | RCC_PERIPHCLK_DFSDM1 | RCC_PERIPHCLK_DFSDM1AUDIO |
        RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_OSPI | RCC_PERIPHCLK_LTDC | RCC_PERIPHCLK_DSI;
    ...
    PeriphClkInit->PLLSAI1.PLLSAI1P =
        ((READ_BIT(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLSAI1P) >> RCC_PLLSAI1CFGR_PLLSAI1P_Pos)
         << 4U) +
        7U;
    PeriphClkInit->PLLSAI1.PLLSAI1Q =
        ((READ_BIT(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLSAI1Q) >> RCC_PLLSAI1CFGR_PLLSAI1Q_Pos) +
         1U) *
        2U;
    ...
    PeriphClkInit->PLLSAI2.PLLSAI2P =
        ((READ_BIT(RCC->PLLSAI2CFGR, RCC_PLLSAI2CFGR_PLLSAI2P) >> RCC_PLLSAI2CFGR_PLLSAI2P_Pos)
         << 4U) +
        7U;
#if defined(RCC_PLLSAI2Q_DIV_SUPPORT)
    PeriphClkInit->PLLSAI2.PLLSAI2Q =
        ((READ_BIT(RCC->PLLSAI2CFGR, RCC_PLLSAI2CFGR_PLLSAI2Q) >> RCC_PLLSAI2CFGR_PLLSAI2Q_Pos) +
         1U) *
        2U;
#endif /* RCC_PLLSAI2Q_DIV_SUPPORT */
    PeriphClkInit->PLLSAI2.PLLSAI2R =
        ((READ_BIT(RCC->PLLSAI2CFGR, RCC_PLLSAI2CFGR_PLLSAI2R) >> RCC_PLLSAI2CFGR_PLLSAI2R_Pos) +
         1U) *
        2U;
            ...
            case RCC_CCIPR_CLK48SEL_1: /* PLL ? */
                if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLLRDY)) {
                    if (HAL_IS_BIT_SET(RCC->PLLCFGR, RCC_PLLCFGR_PLLQEN)) {
                        ...
                        pllvco = ((pllvco * plln) / ((READ_BIT(RCC->PLLCFGR, RCC_PLLCFGR_PLLM) >>
            ...
            case RCC_CCIPR_CLK48SEL_0: /* PLLSAI1 ? */
                if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLLSAI1RDY)) {
                    if (HAL_IS_BIT_SET(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLSAI1QEN)) {
                        ...
                        frequency =
                            (pllvco / (((READ_BIT(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLSAI1Q) >>
                ...
                case RCC_CCIPR_CLK48SEL_1: /* PLL "Q" ? */
                    if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLLRDY)) {
                        if (HAL_IS_BIT_SET(RCC->PLLCFGR, RCC_PLLCFGR_PLLQEN)) {
                            ...
                            plln = READ_BIT(RCC->PLLCFGR, RCC_PLLCFGR_PLLN) >> RCC_PLLCFGR_PLLN_Pos;
                            pllvco =
                                ((pllvco * plln) / ((READ_BIT(RCC->PLLCFGR, RCC_PLLCFGR_PLLM) >>
                                                     RCC_PLLCFGR_PLLM_Pos) +
                                                    1U));
                            /* f(PLL48M1CLK) = f(VCO input) / PLLQ */
        ...
        case RCC_PERIPHCLK_ADC: {
            ...
            case RCC_ADCCLKSOURCE_PLLSAI1:
                if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLLSAI1RDY) &&
                    ...
                    /* f(PLLSAI1 Source) * PLLSAI1N / PLLSAI1M */
                    pllvco =
                        ((pllvco * plln) / ((READ_BIT(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLSAI1M) >>
                                             RCC_PLLSAI1CFGR_PLLSAI1M_Pos) +
                                            1U));
#else
                    /* f(PLL Source) * PLLSAI1N / PLLM */
                    ...
                    frequency = (pllvco / (((READ_BIT(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLSAI1R) >>
    ...
    defined(STM32L485xx) || defined(STM32L486xx) || defined(STM32L496xx) || defined(STM32L4A6xx)
            case RCC_ADCCLKSOURCE_PLLSAI2:
                if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLLSAI2RDY) &&
                    ...
                    pllvco =
                        ((pllvco * plln) / ((READ_BIT(RCC->PLLSAI2CFGR, RCC_PLLSAI2CFGR_PLLSAI2M) >>
                    ...
                    frequency = (pllvco / (((READ_BIT(RCC->PLLSAI2CFGR, RCC_PLLSAI2CFGR_PLLSAI2R) >>
 ...
 * @note   Delay parameters stand for unitary delays from 0 to 15. Actual delay is Delay1 or Delay2
 * + 1.
 * @retval None
 */
...
@verbatim
 ...
 ===============================================================================
    [..]
      For devices with Clock Recovery System feature (CRS), RCC Extension HAL driver can be used as
follows:
...
/**
 * @brief  Configure the parameters N & P & optionally M of PLLSAI1 and enable PLLSAI1 output
 * clock(s).
 * @param  PllSai1  pointer to an RCC_PLLSAI1InitTypeDef structure that
 *         contains the configuration parameters N & P & optionally M as well as PLLSAI1 output
 * clock(s)
...
/**
 * @brief  Configure the parameters N & P & optionally M of PLLSAI2 and enable PLLSAI2 output
 * clock(s).
 * @param  PllSai2  pointer to an RCC_PLLSAI2InitTypeDef structure that
 *         contains the configuration parameters N & P & optionally M as well as PLLSAI2 output
 * clock(s)
 * @param  Divider  divider parameter to be updated
 *
