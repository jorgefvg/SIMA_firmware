...
typedef struct {
    ...
    uint32_t PLLM; /*!< PLLM: Division factor for PLL VCO input clock.
                        This parameter must be a number between Min_Data = 1 and Max_Data = 16 on
                      STM32L4Rx/STM32L4Sx devices. This parameter must be a number between Min_Data
                      = 1 and Max_Data = 8 on the other devices */
...
/**
 * @brief  RCC Internal/External Oscillator (HSE, HSI, MSI, LSE and LSI) configuration structure
 * definition
 */
typedef struct {
    ...
    uint32_t HSICalibrationValue; /*!< The calibration trimming value (default is
                                     RCC_HSICALIBRATION_DEFAULT). This parameter must be a number
                                     between Min_Data = 0 and Max_Data = 31 on
                                       STM32L43x/STM32L44x/STM32L47x/STM32L48x devices.
                                       This parameter must be a number between Min_Data = 0 and
                                     Max_Data = 127 on the other devices */
    ...
    uint32_t HSI48State; /*!< The new state of the HSI48 (only applicable to
                            STM32L43x/STM32L44x/STM32L49x/STM32L4Ax devices). This parameter can be
                            a value of @ref RCC_HSI48_Config */
...
typedef struct {
    ...
    uint32_t AHBCLKDivider; /*!< The AHB clock (HCLK) divider. This clock is derived from the system
                               clock (SYSCLK). This parameter can be a value of @ref
...
#define RCC_LSE_ON_RTC_ONLY                                                                        \
    (RCC_BDCR_LSESYSDIS | RCC_BDCR_LSEON) /*!< LSE clock activation without propagation to system  \
                                           */
...
#define RCC_HSICALIBRATION_DEFAULT                                                                 \
    0x40U /*!< Default HSI calibration trimming value 64 on devices other than                     \
...
#define RCC_MCO1SOURCE_PLLCLK                                                                      \
    (RCC_CFGR_MCOSEL_0 | RCC_CFGR_MCOSEL_2) /*!< PLLCLK selection as MCO1 source */
 ...
 * STM32L43x/STM32L44x/STM32L47x/STM32L48x or between 0 and 127 on other devices.
 * @retval None
 */
...
#define __HAL_RCC_GET_MSI_RANGE()                                                                  \
    ((READ_BIT(RCC->CR, RCC_CR_MSIRGSEL) != 0U) ? READ_BIT(RCC->CR, RCC_CR_MSIRANGE)               \
 ...
 *         This parameter must be a number between Min_Data = 1 and Max_Data = 16 on
 * STM32L4Rx/STM32L4Sx devices. This parameter must be a number between Min_Data = 1 and Max_Data =
 * 8 on other devices.
...
#define __HAL_RCC_PLL_CONFIG(__PLLSOURCE__, __PLLM__, __PLLN__, __PLLP__, __PLLQ__, __PLLR__)      \
    MODIFY_REG(RCC->PLLCFGR,                                                                       \
               (RCC_PLLCFGR_PLLSRC | RCC_PLLCFGR_PLLM | RCC_PLLCFGR_PLLN | RCC_PLLCFGR_PLLQ |      \
                RCC_PLLCFGR_PLLR | RCC_PLLCFGR_PLLP | RCC_PLLCFGR_PLLPDIV),                        \
...
#define __HAL_RCC_PLL_CONFIG(__PLLSOURCE__, __PLLM__, __PLLN__, __PLLP__, __PLLQ__, __PLLR__)      \
    MODIFY_REG(RCC->PLLCFGR,                                                                       \
               (RCC_PLLCFGR_PLLSRC | RCC_PLLCFGR_PLLM | RCC_PLLCFGR_PLLN | RCC_PLLCFGR_PLLQ |      \
                RCC_PLLCFGR_PLLR | RCC_PLLCFGR_PLLP),                                              \
               ((__PLLSOURCE__) | (((__PLLM__)-1U) << RCC_PLLCFGR_PLLM_Pos) |                      \
                ((__PLLN__) << RCC_PLLCFGR_PLLN_Pos) |                                             \
                ((((__PLLQ__) >> 1U) - 1U) << RCC_PLLCFGR_PLLQ_Pos) |                              \
                ((((__PLLR__) >> 1U) - 1U) << RCC_PLLCFGR_PLLR_Pos) |                              \
 ...
 * @note   Enabling/disabling clock outputs RCC_PLL_SAI3CLK and RCC_PLL_48M1CLK can be done at
 ...
 * (48 MHz), the random analog generator (<=48 MHz) and the SDMMC1 (<= 48 MHz).
...
#define IS_RCC_LSE(__LSE__)                                                                        \
    (((__LSE__) == RCC_LSE_OFF) || ((__LSE__) == RCC_LSE_ON) ||                                    \
     ((__LSE__) == RCC_LSE_BYPASS_RTC_ONLY) || ((__LSE__) == RCC_LSE_ON_RTC_ONLY) ||               \
...
#define IS_RCC_PLLSOURCE(__SOURCE__)                                                               \
    (((__SOURCE__) == RCC_PLLSOURCE_NONE) || ((__SOURCE__) == RCC_PLLSOURCE_MSI) ||                \
