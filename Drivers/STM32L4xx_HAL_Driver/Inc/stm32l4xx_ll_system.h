...
#define LL_SYSCFG_EXTI_LINE0                                                                       \
    (uint32_t)((0x000FU << LL_EXTI_REGISTER_PINPOS_SHFT) | 0U) /* !< EXTI_POSITION_0  | EXTICR[0]  \
                                                                */
#define LL_SYSCFG_EXTI_LINE1                                                                       \
    (uint32_t)((0x00F0U << LL_EXTI_REGISTER_PINPOS_SHFT) | 0U) /* !< EXTI_POSITION_4  | EXTICR[0]  \
                                                                */
#define LL_SYSCFG_EXTI_LINE2                                                                       \
    (uint32_t)((0x0F00U << LL_EXTI_REGISTER_PINPOS_SHFT) | 0U) /* !< EXTI_POSITION_8  | EXTICR[0]  \
                                                                */
#define LL_SYSCFG_EXTI_LINE3                                                                       \
    (uint32_t)((0xF000U << LL_EXTI_REGISTER_PINPOS_SHFT) | 0U) /* !< EXTI_POSITION_12 | EXTICR[0]  \
                                                                */
#define LL_SYSCFG_EXTI_LINE4                                                                       \
    (uint32_t)((0x000FU << LL_EXTI_REGISTER_PINPOS_SHFT) | 1U) /* !< EXTI_POSITION_0  | EXTICR[1]  \
                                                                */
#define LL_SYSCFG_EXTI_LINE5                                                                       \
    (uint32_t)((0x00F0U << LL_EXTI_REGISTER_PINPOS_SHFT) | 1U) /* !< EXTI_POSITION_4  | EXTICR[1]  \
                                                                */
#define LL_SYSCFG_EXTI_LINE6                                                                       \
    (uint32_t)((0x0F00U << LL_EXTI_REGISTER_PINPOS_SHFT) | 1U) /* !< EXTI_POSITION_8  | EXTICR[1]  \
                                                                */
#define LL_SYSCFG_EXTI_LINE7                                                                       \
    (uint32_t)((0xF000U << LL_EXTI_REGISTER_PINPOS_SHFT) | 1U) /* !< EXTI_POSITION_12 | EXTICR[1]  \
                                                                */
#define LL_SYSCFG_EXTI_LINE8                                                                       \
    (uint32_t)((0x000FU << LL_EXTI_REGISTER_PINPOS_SHFT) | 2U) /* !< EXTI_POSITION_0  | EXTICR[2]  \
                                                                */
#define LL_SYSCFG_EXTI_LINE9                                                                       \
    (uint32_t)((0x00F0U << LL_EXTI_REGISTER_PINPOS_SHFT) | 2U) /* !< EXTI_POSITION_4  | EXTICR[2]  \
                                                                */
#define LL_SYSCFG_EXTI_LINE10                                                                      \
    (uint32_t)((0x0F00U << LL_EXTI_REGISTER_PINPOS_SHFT) | 2U) /* !< EXTI_POSITION_8  | EXTICR[2]  \
                                                                */
#define LL_SYSCFG_EXTI_LINE11                                                                      \
    (uint32_t)((0xF000U << LL_EXTI_REGISTER_PINPOS_SHFT) | 2U) /* !< EXTI_POSITION_12 | EXTICR[2]  \
                                                                */
#define LL_SYSCFG_EXTI_LINE12                                                                      \
    (uint32_t)((0x000FU << LL_EXTI_REGISTER_PINPOS_SHFT) | 3U) /* !< EXTI_POSITION_0  | EXTICR[3]  \
                                                                */
#define LL_SYSCFG_EXTI_LINE13                                                                      \
    (uint32_t)((0x00F0U << LL_EXTI_REGISTER_PINPOS_SHFT) | 3U) /* !< EXTI_POSITION_4  | EXTICR[3]  \
                                                                */
#define LL_SYSCFG_EXTI_LINE14                                                                      \
    (uint32_t)((0x0F00U << LL_EXTI_REGISTER_PINPOS_SHFT) | 3U) /* !< EXTI_POSITION_8  | EXTICR[3]  \
                                                                */
#define LL_SYSCFG_EXTI_LINE15                                                                      \
    (uint32_t)((0xF000U << LL_EXTI_REGISTER_PINPOS_SHFT) | 3U) /* !< EXTI_POSITION_12 | EXTICR[3]  \
                                                                */
/**
 * @}
 */
...
#define LL_DBGMCU_TRACE_SYNCH_SIZE1                                                                \
    (DBGMCU_CR_TRACE_IOEN | DBGMCU_CR_TRACE_MODE_0) /*!< TRACE pin assignment for Synchronous Mode \
                                                       with a TRACEDATA size of 1 */
#define LL_DBGMCU_TRACE_SYNCH_SIZE2                                                                \
    (DBGMCU_CR_TRACE_IOEN | DBGMCU_CR_TRACE_MODE_1) /*!< TRACE pin assignment for Synchronous Mode \
...
#define LL_DBGMCU_APB1_GRP1_TIM3_STOP                                                              \
    DBGMCU_APB1FZR1_DBG_TIM3_STOP /*!< The counter clock of TIM3 is stopped when the core is       \
                                     halted*/
#endif                            /* TIM3 */
#if defined(TIM4)
#define LL_DBGMCU_APB1_GRP1_TIM4_STOP                                                              \
    DBGMCU_APB1FZR1_DBG_TIM4_STOP /*!< The counter clock of TIM4 is stopped when the core is       \
                                     halted*/
#endif                            /* TIM4 */
#if defined(TIM5)
#define LL_DBGMCU_APB1_GRP1_TIM5_STOP                                                              \
    DBGMCU_APB1FZR1_DBG_TIM5_STOP /*!< The counter clock of TIM5 is stopped when the core is       \
                                     halted*/
#endif                            /* TIM5 */
#define LL_DBGMCU_APB1_GRP1_TIM6_STOP                                                              \
    DBGMCU_APB1FZR1_DBG_TIM6_STOP /*!< The counter clock of TIM6 is stopped when the core is       \
                                     halted*/
#if defined(TIM7)
#define LL_DBGMCU_APB1_GRP1_TIM7_STOP                                                              \
    DBGMCU_APB1FZR1_DBG_TIM7_STOP /*!< The counter clock of TIM7 is stopped when the core is       \
                                     halted*/
#endif                            /* TIM7 */
...
#define LL_DBGMCU_APB1_GRP1_WWDG_STOP                                                              \
    DBGMCU_APB1FZR1_DBG_WWDG_STOP /*!< The window watchdog counter clock is stopped when the core  \
                                     is halted*/
#define LL_DBGMCU_APB1_GRP1_IWDG_STOP                                                              \
    DBGMCU_APB1FZR1_DBG_IWDG_STOP /*!< The independent watchdog counter clock is stopped when the  \
                                     core is halted*/
...
#define LL_DBGMCU_APB1_GRP1_LPTIM1_STOP                                                            \
    DBGMCU_APB1FZR1_DBG_LPTIM1_STOP /*!< The counter clock of LPTIM1 is stopped when the core is   \
                                       halted*/
/**
 * @}
 */
...
#define LL_DBGMCU_APB1_GRP2_LPTIM2_STOP                                                            \
    DBGMCU_APB1FZR2_DBG_LPTIM2_STOP /*!< The counter clock of LPTIM2 is stopped when the core is   \
                                       halted*/
/**
 * @}
 */
...
#define LL_DBGMCU_APB2_GRP1_TIM1_STOP                                                              \
    DBGMCU_APB2FZ_DBG_TIM1_STOP /*!< The counter clock of TIM1 is stopped when the core is         \
                                   halted*/
#if defined(TIM8)
#define LL_DBGMCU_APB2_GRP1_TIM8_STOP                                                              \
    DBGMCU_APB2FZ_DBG_TIM8_STOP /*!< The counter clock of TIM8 is stopped when the core is         \
                                   halted*/
#endif                          /* TIM8 */
#define LL_DBGMCU_APB2_GRP1_TIM15_STOP                                                             \
    DBGMCU_APB2FZ_DBG_TIM15_STOP /*!< The counter clock of TIM15 is stopped when the core is       \
                                    halted*/
#define LL_DBGMCU_APB2_GRP1_TIM16_STOP                                                             \
    DBGMCU_APB2FZ_DBG_TIM16_STOP /*!< The counter clock of TIM16 is stopped when the core is       \
                                    halted*/
#if defined(TIM17)
#define LL_DBGMCU_APB2_GRP1_TIM17_STOP                                                             \
    DBGMCU_APB2FZ_DBG_TIM17_STOP /*!< The counter clock of TIM17 is stopped when the core is       \
                                    halted*/
#endif                           /* TIM17 */
/**
 * @}
...
__STATIC_INLINE void LL_SYSCFG_SetEXTISource(uint32_t Port, uint32_t Line) {
    MODIFY_REG(SYSCFG->EXTICR[Line & 0x03U], (Line >> LL_EXTI_REGISTER_PINPOS_SHFT),
               Port << POSITION_VAL((Line >> LL_EXTI_REGISTER_PINPOS_SHFT)));
}
...
__STATIC_INLINE uint32_t LL_SYSCFG_GetEXTISource(uint32_t Line) {
    return (
        uint32_t)(READ_BIT(SYSCFG->EXTICR[Line & 0x03U], (Line >> LL_EXTI_REGISTER_PINPOS_SHFT)) >>
                  POSITION_VAL(Line >> LL_EXTI_REGISTER_PINPOS_SHFT));
}
