...
typedef struct {
    uint32_t Multiplexer; /*!< Input is external serial inputs, internal register or ADC output.
                               ADC output is available only on STM32L451xx, STM32L452xx,
                             STM32L462xx, STM32L496xx, STM32L4A6xx, STM32L4R5xx, STM32L4R7xx,
                             STM32L4R9xx, STM32L4S5xx, STM32L4S7xx, STM32L4S9xx, STM32L4P5xx and
                             STM32L4Q5xx products. This parameter can be a value of @ref
...
typedef struct {
    ...
    DFSDM_Channel_SerialInterfaceTypeDef
        SerialInterface;          /*!< DFSDM channel serial interface parameters */
    DFSDM_Channel_AwdTypeDef Awd; /*!< DFSDM channel analog watchdog parameters */
    int32_t Offset;               /*!< DFSDM channel offset.
                                       This parameter must be a number between Min_Data = -8388608 and Max_Data =
                                     8388607 */
...
#if (USE_HAL_DFSDM_REGISTER_CALLBACKS == 1)
    void (*CkabCallback)(struct __DFSDM_Channel_HandleTypeDef *
                             hdfsdm_channel); /*!< DFSDM channel clock absence detection callback */
    void (*ScdCallback)(struct __DFSDM_Channel_HandleTypeDef *
                            hdfsdm_channel); /*!< DFSDM channel short circuit detection callback */
    void (*MspInitCallback)(struct __DFSDM_Channel_HandleTypeDef *
                                hdfsdm_channel); /*!< DFSDM channel MSP init callback */
    void (*MspDeInitCallback)(struct __DFSDM_Channel_HandleTypeDef *
                                  hdfsdm_channel); /*!< DFSDM channel MSP de-init callback */
#endif
...
typedef enum {
    ...
    HAL_DFSDM_FILTER_STATE_REG_INJ =
        0x04U, /*!< DFSDM filter regular and injected conversions in progress */
 ...
 */
typedef struct {
    uint32_t Trigger;         /*!< Trigger used to start injected conversion: software, external or
                                 synchronous.         This parameter can be a value of @ref
    ...
    uint32_t
        ExtTriggerEdge; /*!< External trigger edge: rising, falling or both.
...
#endif /* USE_HAL_DFSDM_REGISTER_CALLBACKS */
{
    ...
    void (*RegConvCpltCallback)(
        struct __DFSDM_Filter_HandleTypeDef *
            hdfsdm_filter); /*!< DFSDM filter regular conversion complete callback */
    void (*RegConvHalfCpltCallback)(
        struct __DFSDM_Filter_HandleTypeDef *
            hdfsdm_filter); /*!< DFSDM filter half regular conversion complete callback */
    void (*InjConvCpltCallback)(
        struct __DFSDM_Filter_HandleTypeDef *
            hdfsdm_filter); /*!< DFSDM filter injected conversion complete callback */
    void (*InjConvHalfCpltCallback)(
        struct __DFSDM_Filter_HandleTypeDef *
            hdfsdm_filter); /*!< DFSDM filter half injected conversion complete callback */
    void (*ErrorCallback)(
        struct __DFSDM_Filter_HandleTypeDef * hdfsdm_filter); /*!< DFSDM filter error callback */
    void (*MspInitCallback)(
        struct __DFSDM_Filter_HandleTypeDef * hdfsdm_filter); /*!< DFSDM filter MSP init callback */
    void (*MspDeInitCallback)(struct __DFSDM_Filter_HandleTypeDef *
                                  hdfsdm_filter); /*!< DFSDM filter MSP de-init callback */
#endif
...
typedef struct {
    ...
    uint32_t
        Channel;              /*!< Analog watchdog channel selection.
...
typedef enum {
    HAL_DFSDM_FILTER_REGCONV_COMPLETE_CB_ID =
        0x00U, /*!< DFSDM filter regular conversion complete callback ID */
    HAL_DFSDM_FILTER_REGCONV_HALFCOMPLETE_CB_ID =
        0x01U, /*!< DFSDM filter half regular conversion complete callback ID */
    HAL_DFSDM_FILTER_INJCONV_COMPLETE_CB_ID =
        0x02U, /*!< DFSDM filter injected conversion complete callback ID */
...
typedef void (*pDFSDM_Filter_AwdCallbackTypeDef)(DFSDM_Filter_HandleTypeDef * hdfsdm_filter,
...
#define DFSDM_CHANNEL_OUTPUT_CLOCK_SYSTEM                                                          \
    0x00000000U /*!< Source for output clock is system clock */
#define DFSDM_CHANNEL_OUTPUT_CLOCK_AUDIO                                                           \
    DFSDM_CHCFGR1_CKOUTSRC /*!< Source for output clock is audio clock */
/**
 * @}
 */
...
#endif /* STM32L451xx || STM32L452xx || STM32L462xx || STM32L496xx || STM32L4A6xx || STM32L4R5xx   \
          || STM32L4R7xx || STM32L4R9xx || STM32L4S5xx || STM32L4S7xx || STM32L4S9xx ||            \
          STM32L4P5xx || STM32L4Q5xx */
#define DFSDM_CHANNEL_INTERNAL_REGISTER                                                            \
    DFSDM_CHCFGR1_DATMPX_1 /*!< Data are taken from internal register */
/**
 * @}
 */
...
#define DFSDM_CHANNEL_INTERLEAVED_MODE                                                             \
    DFSDM_CHCFGR1_DATPACK_0                             /*!< Interleaved data packing mode         \
                                                         */
...
#define DFSDM_CHANNEL_FOLLOWING_CHANNEL_PINS                                                       \
    DFSDM_CHCFGR1_CHINSEL /*!< Input from pins on following channel */
/**
 * @}
 */
...
#define DFSDM_FILTER_EXT_TRIGGER                                                                   \
    0x00000002U /*!< External trigger (only for injected conversion)                               \
                 */
/**
 * @}
 */
...
#define DFSDM_FILTER_EXT_TRIG_TIM1_TRGO2                                                           \
    DFSDM_FLTCR1_JEXTSEL_0 /*!< For DFSDM filter 0, 1, 2 and 3 */
#define DFSDM_FILTER_EXT_TRIG_TIM3_TRGO                                                            \
    DFSDM_FLTCR1_JEXTSEL_1 /*!< For DFSDM filter 0, 1, 2 and 3 */
...
#elif defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) ||                      \
...
#define DFSDM_FILTER_EXT_TRIG_TIM6_TRGO                                                            \
    (DFSDM_FLTCR1_JEXTSEL_0 | DFSDM_FLTCR1_JEXTSEL_1 |                                             \
...
#define DFSDM_FILTER_EXT_TRIG_EXTI15                                                               \
    (DFSDM_FLTCR1_JEXTSEL_0 | DFSDM_FLTCR1_JEXTSEL_3 |                                             \
     DFSDM_FLTCR1_JEXTSEL_4) /*!< For all DFSDM filters */
#define DFSDM_FILTER_EXT_TRIG_LPTIM1_OUT                                                           \
    (DFSDM_FLTCR1_JEXTSEL_1 | DFSDM_FLTCR1_JEXTSEL_3 |                                             \
     DFSDM_FLTCR1_JEXTSEL_4) /*!< For all DFSDM filters */
#else
#define DFSDM_FILTER_EXT_TRIG_TIM1_TRGO 0x00000000U /*!< For DFSDM filter 0, 1, 2 and 3 */
#define DFSDM_FILTER_EXT_TRIG_TIM1_TRGO2                                                           \
...
#define DFSDM_FILTER_EXT_TRIG_TIM8_TRGO2                                                           \
    (DFSDM_FLTCR1_JEXTSEL_0 | DFSDM_FLTCR1_JEXTSEL_1) /*!< For DFSDM filter 0, 1 and 2 */
#define DFSDM_FILTER_EXT_TRIG_TIM3_TRGO                                                            \
    (DFSDM_FLTCR1_JEXTSEL_0 | DFSDM_FLTCR1_JEXTSEL_1)          /*!< For DFSDM filter 3 */
...
#define DFSDM_FILTER_EXT_TRIG_BOTH_EDGES                                                           \
    DFSDM_FLTCR1_JEXTEN /*!< External rising and falling edges */
/**
 * @}
 */
...
#define DFSDM_FILTER_ERROR_REGULAR_OVERRUN                                                         \
    0x00000001U /*!< Overrun occurs during regular conversion */
#define DFSDM_FILTER_ERROR_INJECTED_OVERRUN                                                        \
    0x00000002U                            /*!< Overrun occurs during injected conversion */
...
/** @addtogroup DFSDM_Exported_Functions_Group1_Channel Channel initialization and de-initialization
 * functions
 * @{
 */
...
HAL_StatusTypeDef
HAL_DFSDM_Channel_UnRegisterCallback(DFSDM_Channel_HandleTypeDef * hdfsdm_channel,
                                     HAL_DFSDM_Channel_CallbackIDTypeDef CallbackID);
#endif
/**
 * @}
...
/** @addtogroup DFSDM_Exported_Functions_Group1_Filter Filter initialization and de-initialization
 * functions
 * @{
 */
...
HAL_StatusTypeDef
HAL_DFSDM_Filter_UnRegisterCallback(DFSDM_Filter_HandleTypeDef * hdfsdm_filter,
                                    HAL_DFSDM_Filter_CallbackIDTypeDef CallbackID);
...
HAL_StatusTypeDef HAL_DFSDM_FilterConfigRegChannel(DFSDM_Filter_HandleTypeDef * hdfsdm_filter,
                                                   uint32_t Channel, uint32_t ContinuousMode);
...
#define IS_DFSDM_CHANNEL_OUTPUT_CLOCK(CLOCK)                                                       \
    (((CLOCK) == DFSDM_CHANNEL_OUTPUT_CLOCK_SYSTEM) ||                                             \
...
#define IS_DFSDM_CHANNEL_SPI_CLOCK(TYPE)                                                           \
    (((TYPE) == DFSDM_CHANNEL_SPI_CLOCK_EXTERNAL) ||                                               \
...
#define IS_DFSDM_FILTER_EXT_TRIG_EDGE(EDGE)                                                        \
    (((EDGE) == DFSDM_FILTER_EXT_TRIG_RISING_EDGE) ||                                              \
...
#define IS_DFSDM_REGULAR_CHANNEL(CHANNEL)                                                          \
    (((CHANNEL) == DFSDM_CHANNEL_0) || ((CHANNEL) == DFSDM_CHANNEL_1) ||                           \
     ((CHANNEL) == DFSDM_CHANNEL_2) || ((CHANNEL) == DFSDM_CHANNEL_3))
#define IS_DFSDM_INJECTED_CHANNEL(CHANNEL) (((CHANNEL) != 0U) && ((CHANNEL) <= 0x0003000FU))
#else
#define IS_DFSDM_REGULAR_CHANNEL(CHANNEL)                                                          \
    (((CHANNEL) == DFSDM_CHANNEL_0) || ((CHANNEL) == DFSDM_CHANNEL_1) ||                           \
     ((CHANNEL) == DFSDM_CHANNEL_2) || ((CHANNEL) == DFSDM_CHANNEL_3) ||                           \
     ((CHANNEL) == DFSDM_CHANNEL_4) || ((CHANNEL) == DFSDM_CHANNEL_5) ||                           \
...
#define IS_DFSDM_CONTINUOUS_MODE(MODE)                                                             \
    (((MODE) == DFSDM_CONTINUOUS_CONV_OFF) || ((MODE) == DFSDM_CONTINUOUS_CONV_ON))
/**
 * @}
 */
