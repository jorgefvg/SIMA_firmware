...
@if STM32L486xx
                           @arg @ref PWR_PVM_2 Peripheral Voltage Monitoring 2 enable: VDDIO2 versus
0.9 V (applicable when VDDIO2 is present on device).
@endif
                           @arg @ref PWR_PVM_3 Peripheral Voltage Monitoring 3 enable: VDDA
versus 1.62 V.
                           @arg @ref PWR_PVM_4 Peripheral Voltage Monitoring 4 enable: VDDA
versus 2.2 V. */
...
#define PWR_PVM_2                                                                                  \
    PWR_CR2_PVME2 /*!< Peripheral Voltage Monitoring 2 enable: VDDIO2 versus 0.9 V (applicable     \
                     when VDDIO2 is present on device) */
#endif            /* PWR_CR2_PVME2 */
...
#define PWR_4KBYTES_SRAM2_RETENTION                                                                \
    PWR_CR3_RRS_1 /*!< Only 4 Kbytes of SRAM2 is powered by the low-power regulator in Standby     \
                     mode */
#else
#define PWR_FULL_SRAM2_RETENTION                                                                   \
...
#define IS_PWR_GPIO(GPIO)                                                                          \
    (((GPIO) == PWR_GPIO_A) || ((GPIO) == PWR_GPIO_B) || ((GPIO) == PWR_GPIO_C) ||                 \
     ((GPIO) == PWR_GPIO_D) || ((GPIO) == PWR_GPIO_H))
...
#define IS_PWR_GPIO(GPIO)                                                                          \
    (((GPIO) == PWR_GPIO_A) || ((GPIO) == PWR_GPIO_B) || ((GPIO) == PWR_GPIO_C) ||                 \
     ((GPIO) == PWR_GPIO_D) || ((GPIO) == PWR_GPIO_E) || ((GPIO) == PWR_GPIO_F) ||                 \
     ((GPIO) == PWR_GPIO_G) || ((GPIO) == PWR_GPIO_H) || ((GPIO) == PWR_GPIO_I))
#endif
