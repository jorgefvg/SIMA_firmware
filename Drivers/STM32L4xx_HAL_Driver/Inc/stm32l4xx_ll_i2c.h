...
#define LL_I2C_ADDRESSING_MODE_10BIT                                                               \
    I2C_CR2_ADD10 /*!< Master operates in 10-bit addressing                                        \
                     mode.*/
/**
 * @}
 */
...
/**
  ...
  */
#define __LL_I2C_CONVERT_TIMINGS(__PRESCALER__, __SETUP_TIME__, __HOLD_TIME__, __SCLH_PERIOD__,    \
                                 __SCLL_PERIOD__)                                                  \
...
__STATIC_INLINE void LL_I2C_HandleTransfer(I2C_TypeDef * I2Cx, uint32_t SlaveAddr,
    ...
    MODIFY_REG(I2Cx->CR2,
               I2C_CR2_SADD | I2C_CR2_ADD10 |
                   ...
                   I2C_CR2_START | I2C_CR2_STOP | I2C_CR2_RELOAD | I2C_CR2_NBYTES |
                   I2C_CR2_AUTOEND | I2C_CR2_HEAD10R,
               tmp);
}
