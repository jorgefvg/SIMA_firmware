...
#define LL_PWR_PVDLEVEL_7                                                                          \
    (PWR_CR2_PLS_LEV7) /* External input analog voltage   (Compare internally to VREFINT) */
/**
 * @}
 */
 ...
 * @note   This configuration may be completed with LL_PWR_EnableRange1BoostMode() on
 * STM32L4Rx/STM32L4Sx devices.
