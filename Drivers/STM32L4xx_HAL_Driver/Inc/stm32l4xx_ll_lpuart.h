...
static const uint16_t LPUART_PRESCALER_TAB[] = {
    (uint16_t)1,  (uint16_t)2,  (uint16_t)4,  (uint16_t)6,  (uint16_t)8,   (uint16_t)10,
...
#define __LL_LPUART_DIV(__PERIPHCLK__, __BAUDRATE__)                                               \
    (uint32_t)(((((uint64_t)(__PERIPHCLK__)*LPUART_LPUARTDIV_FREQ_MUL) +                           \
                 (uint32_t)((__BAUDRATE__) / 2U)) /                                                \
                (__BAUDRATE__)) &                                                                  \
               LPUART_BRR_MASK)
#endif /* USART_PRESC_PRESCALER */
