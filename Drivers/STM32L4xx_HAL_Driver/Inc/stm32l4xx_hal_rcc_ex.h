...
typedef struct {
    ...
    uint32_t PLLSAI1N; /*!< PLLSAI1N: specifies the multiplication factor for PLLSAI1 VCO output
                          clock. This parameter must be a number between 8 and 86 or 127 depending
                          on devices. */
...
typedef struct {
    ...
    uint32_t PLLSAI2N; /*!< PLLSAI2N: specifies the multiplication factor for PLLSAI2 VCO output
                          clock. This parameter must be a number between 8 and 86 or 127 depending
                          on devices. */
...
typedef struct {
    ...
    RCC_PLLSAI1InitTypeDef PLLSAI1; /*!< PLLSAI1 structure parameters.
                                       ...
                                       as Clock Source for SAI1, USB/RNG/SDMMC1 or ADC */
#endif                              /* RCC_PLLSAI1_SUPPORT */
#if defined(RCC_PLLSAI2_SUPPORT)

    RCC_PLLSAI2InitTypeDef PLLSAI2; /*!< PLLSAI2 structure parameters.
                                         This parameter will be used only when PLLSAI2 is selected
                                       as Clock Source for SAI2 or ADC */
    ...
    uint32_t
        UsbClockSelection; /*!< Specifies USB clock source (warning: same source for SDMMC1 and
                              RNG). This parameter can be a value of @ref RCCEx_USB_Clock_Source */

#endif /* USB_OTG_FS || USB */

#if defined(SDMMC1)

    uint32_t Sdmmc1ClockSelection; /*!< Specifies SDMMC1 clock source (warning: same source for USB
                                      and RNG). This parameter can be a value of @ref
                                      RCCEx_SDMMC1_Clock_Source */

#endif /* SDMMC1 */

    uint32_t RngClockSelection; /*!< Specifies RNG clock source (warning: same source for USB and
                                   SDMMC1). This parameter can be a value of @ref
...
typedef struct {
    ...
    uint32_t ReloadValue; /*!< Specifies the value to be loaded in the frequency error counter with
                             ...
                             parameter must be a number between 0 and 0xFFFF or a value of @ref
    ...
    uint32_t ErrorLimitValue; /*!< Specifies the value to be used to evaluate the captured frequency
                                 ...
                                 a value of @ref RCCEx_CRS_ErrorLimitDefault */
    ...
    uint32_t HSI48CalibrationValue; /*!< Specifies a user-programmable trimming value to the HSI48
                                       ...
                                       0x7F for STM32L412xx/L422xx, between 0 and 0x3F otherwise, or
                                       a value of @ref RCCEx_CRS_HSI48CalibrationDefault */
...
typedef struct {
    ...
    uint32_t HSI48CalibrationValue; /*!< Specifies value loaded in HSI48 oscillator smooth trimming.
                                       This parameter must be a number between 0 and 0x7F for
                                       STM32L412xx/L422xx, between 0 and 0x3F otherwise */

    uint32_t
        FreqErrorCapture; /*!< Specifies the value loaded in the .FECAP, the frequency error counter
                                                            value latched in the time of the last
                            SYNC event. This parameter must be a number between 0 and 0xFFFF */
    ...
    uint32_t FreqErrorDirection; /*!< Specifies the value loaded in the .FEDIR, the counting
                                   ...
                                   below or above the target. This parameter must be a value of @ref
...
#endif /* STM32L471xx || STM32L475xx || STM32L476xx || STM32L485xx || STM32L486xx || STM32L496xx   \
          || STM32L4A6xx */
...
#define RCC_CRS_RELOADVALUE_DEFAULT                                                                \
    0x0000BB7FU /*!< The reset value of the RELOAD field corresponds                               \
                     to a target frequency of 48 MHz and a synchronization signal frequency of 1   \
                   kHz (SOF signal from USB). */
/**
 * @}
 */
...
#define RCC_CRS_HSI48CALIBRATION_DEFAULT                                                           \
    0x00000040U /*!< The default value is 64, which corresponds to the middle of the trimming      \
                   interval. The trimming step is specified in the product datasheet. A higher     \
                   TRIM value corresponds to a higher output frequency */
#else
#define RCC_CRS_HSI48CALIBRATION_DEFAULT                                                           \
    0x00000020U /*!< The default value is 32, which corresponds to the middle of the trimming      \
                   interval. The trimming step is specified in the product datasheet. A higher     \
                   TRIM value corresponds to a higher output frequency */
#endif
/**
...
#define __HAL_RCC_PLLSAI1_CONFIG(__PLLSAI1M__, __PLLSAI1N__, __PLLSAI1P__, __PLLSAI1Q__,           \
                                 __PLLSAI1R__)                                                     \
...
#define __HAL_RCC_PLLSAI1_CONFIG(__PLLSAI1N__, __PLLSAI1P__, __PLLSAI1Q__, __PLLSAI1R__)           \
    MODIFY_REG(RCC->PLLSAI1CFGR,                                                                   \
               (RCC_PLLSAI1CFGR_PLLSAI1N | RCC_PLLSAI1CFGR_PLLSAI1P | RCC_PLLSAI1CFGR_PLLSAI1Q |   \
...
/**
 * @brief  Macros to enable or disable each clock output (PLLSAI1_SAI1, PLLSAI1_USB2 and
 * PLLSAI1_ADC1).
 ...
 * achieve high-quality audio performance on SAI interface in case.
 *            @arg @ref RCC_PLLSAI1_48M2CLK  This clock is used to generate the clock for the USB
 * OTG FS (48 MHz), the random number generator (<=48 MHz) and the SDIO (<= 48 MHz).
...
#define __HAL_RCC_PLLSAI2_CONFIG(__PLLSAI2M__, __PLLSAI2N__, __PLLSAI2P__, __PLLSAI2Q__,           \
                                 __PLLSAI2R__)                                                     \
...
#define __HAL_RCC_PLLSAI2_CONFIG(__PLLSAI2N__, __PLLSAI2P__, __PLLSAI2Q__, __PLLSAI2R__)           \
    MODIFY_REG(RCC->PLLSAI2CFGR,                                                                   \
               (RCC_PLLSAI2CFGR_PLLSAI2N | RCC_PLLSAI2CFGR_PLLSAI2P | RCC_PLLSAI2CFGR_PLLSAI2Q |   \
                RCC_PLLSAI2CFGR_PLLSAI2R | RCC_PLLSAI2CFGR_PLLSAI2PDIV),                           \
               (((__PLLSAI2N__) << RCC_PLLSAI2CFGR_PLLSAI2N_Pos) |                                 \
                ((((__PLLSAI2Q__) >> 1U) - 1U) << RCC_PLLSAI2CFGR_PLLSAI2Q_Pos) |                  \
                ((((__PLLSAI2R__) >> 1U) - 1U) << RCC_PLLSAI2CFGR_PLLSAI2R_Pos) |                  \
...
#define __HAL_RCC_PLLSAI2_CONFIG(__PLLSAI2N__, __PLLSAI2P__, __PLLSAI2R__)                         \
    MODIFY_REG(RCC->PLLSAI2CFGR,                                                                   \
               (RCC_PLLSAI2CFGR_PLLSAI2N | RCC_PLLSAI2CFGR_PLLSAI2P | RCC_PLLSAI2CFGR_PLLSAI2R |   \
                RCC_PLLSAI2CFGR_PLLSAI2PDIV),                                                      \
               (((__PLLSAI2N__) << RCC_PLLSAI2CFGR_PLLSAI2N_Pos) |                                 \
                ((((__PLLSAI2R__) >> 1U) - 1U) << RCC_PLLSAI2CFGR_PLLSAI2R_Pos) |                  \
                ((uint32_t)(__PLLSAI2P__) << RCC_PLLSAI2CFGR_PLLSAI2PDIV_Pos)))
...
/**
  * @brief  Macros to enable or disable each clock output (PLLSAI2_SAI2, PLLSAI2_ADC2 and
  RCC_PLLSAI2_DSICLK).
  * @note   Enabling and disabling those clocks can be done without the need to stop the PLL.
  *         This is mainly used to save Power.
  ...
  *         This parameter can be one or a combination of the following values:
  @if STM32L486xx
  *            @arg @ref RCC_PLLSAI2_SAI2CLK  This clock is used to generate an accurate clock to
  achieve
  *                                           high-quality audio performance on SAI interface in
  case.
...
/**
  * @brief  Macro to get clock output enable status (PLLSAI2_SAI2, PLLSAI2_ADC2 and
  RCC_PLLSAI2_DSICLK).
  * @param  __PLLSAI2_CLOCKOUT__ specifies the PLLSAI2 clock to be output.
  *          This parameter can be one of the following values:
  @if STM32L486xx
...
/**
  ...
  *             @arg @ref RCC_SAI1CLKSOURCE_PLLSAI1  SAI1 clock = PLLSAI1 "P" clock (PLLSAI1CLK)
  @if STM32L486xx
  *             @arg @ref RCC_SAI1CLKSOURCE_PLLSAI2  SAI1 clock = PLLSAI2 "P" clock (PLLSAI2CLK) for
  devices with PLLSAI2
  @endif
  *             @arg @ref RCC_SAI1CLKSOURCE_PLL  SAI1 clock  = PLL "P" clock (PLLSAI3CLK if PLLSAI2
  exists, else PLLSAI2CLK)
  ...
  *
  @if STM32L443xx
  * @note  HSI16 is automatically set as SAI1 clock source when PLL are disabled for devices without
  PLLSAI2.
  @endif
  *
  * @retval None
...
/** @brief  Macro to get the SAI1 clock source.
  ...
  *             @arg @ref RCC_SAI1CLKSOURCE_PIN  SAI1 clock = External Clock (SAI1_EXTCLK)
  *
  * @note  Despite returned values RCC_SAI1CLKSOURCE_PLLSAI1 or RCC_SAI1CLKSOURCE_PLL, HSI16 is
  automatically set as SAI1
...
/** @brief  Macro to configure the SDMMC1 clock.
  ...
  *         This parameter can be one of the following values:
  @if STM32L486xx
  *            @arg @ref RCC_SDMMC1CLKSOURCE_NONE  No clock selected as SDMMC1 clock for devices
  without HSI48
...
/** @brief  Macro to get the SDMMC1 clock.
  ...
  *            @arg @ref RCC_SDMMC1CLKSOURCE_NONE  No clock selected as SDMMC1 clock for devices
  without HSI48
  *            @arg @ref RCC_SDMMC1CLKSOURCE_MSI  MSI selected as SDMMC1 clock
  *            @arg @ref RCC_SDMMC1CLKSOURCE_PLLSAI1  PLLSAI1 "Q" clock (PLL48M2CLK) selected as
  SDMMC1 clock
  @endif
  @if STM32L443xx
  *            @arg @ref RCC_SDMMC1CLKSOURCE_HSI48  HSI48 selected as SDMMC1 clock for devices with
  ...
  *            @arg @ref RCC_SDMMC1CLKSOURCE_PLLSAI1  PLLSAI1 "Q" clock (PLL48M2CLK) selected as
  SDMMC1 clock
  *            @arg @ref RCC_SDMMC1CLKSOURCE_PLLP  PLL "P" clock (PLLSAI3CLK) selected as SDMMC1
  kernel clock
  @endif
  *            @arg @ref RCC_SDMMC1CLKSOURCE_PLL  PLL "Q" clock (PLL48M1CLK) selected as SDMMC1
  clock
  */
#if defined(RCC_CCIPR2_SDMMCSEL)
...
/** @brief  Macro to configure the RNG clock.
  ...
  *         This parameter can be one of the following values:
  @if STM32L486xx
  *            @arg @ref RCC_RNGCLKSOURCE_NONE  No clock selected as RNG clock for devices without
  HSI48
  @endif
  @if STM32L443xx
  *            @arg @ref RCC_RNGCLKSOURCE_HSI48  HSI48 selected as RNG clock clock for devices with
  HSI48
  @endif
...
/** @brief  Macro to get the RNG clock.
  ...
  *            @arg @ref RCC_RNGCLKSOURCE_HSI48  HSI48 selected as RNG clock clock for devices with
  ...
  @endif
  *            @arg @ref RCC_RNGCLKSOURCE_MSI  MSI selected as RNG clock
  *            @arg @ref RCC_RNGCLKSOURCE_PLLSAI1  PLLSAI1 "Q" clock (PLL48M2CLK) selected as RNG
  clock
...
/** @brief  Macro to configure the USB clock (USBCLK).
  ...
  *         This parameter can be one of the following values:
  @if STM32L486xx
  *            @arg @ref RCC_USBCLKSOURCE_NONE  No clock selected as 48MHz clock for devices without
  HSI48
  @endif
  @if STM32L443xx
...
/** @brief  Macro to configure the ADC interface clock.
  ...
  *            @arg @ref RCC_ADCCLKSOURCE_PLLSAI1  PLLSAI1 Clock selected as ADC clock
  @if STM32L486xx
  *            @arg @ref RCC_ADCCLKSOURCE_PLLSAI2  PLLSAI2 Clock selected as ADC clock for
  STM32L47x/STM32L48x/STM32L49x/STM32L4Ax devices
  @endif
...
#define __HAL_RCC_GET_ADC_SOURCE()                                                                 \
    ((__HAL_RCC_ADC_IS_CLK_ENABLED() != 0U) ? RCC_ADCCLKSOURCE_SYSCLK : RCC_ADCCLKSOURCE_NONE)
 ...
 *         This parameter can be one of the following values:
 *            @arg @ref RCC_LTDCCLKSOURCE_PLLSAI2_DIV2   PLLSAI2 divider R divided by 2 clock
 * selected as LTDC clock
 *            @arg @ref RCC_LTDCCLKSOURCE_PLLSAI2_DIV4   PLLSAI2 divider R divided by 4 clock
 * selected as LTDC clock
 *            @arg @ref RCC_LTDCCLKSOURCE_PLLSAI2_DIV8   PLLSAI2 divider R divided by 8 clock
 * selected as LTDC clock
 *            @arg @ref RCC_LTDCCLKSOURCE_PLLSAI2_DIV16  PLLSAI2 divider R divided by 16 clock
 * selected as LTDC clock
 * @retval None
 */
...
#define RCC_PERIPHCLOCK_ALL                                                                        \
    (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 | RCC_PERIPHCLK_LPUART1 |  \
     RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 | RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_LPTIM1 |         \
     RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_USB | RCC_PERIPHCLK_ADC | RCC_PERIPHCLK_RTC |            \
     RCC_PERIPHCLK_RNG)
#elif defined(STM32L431xx)
#define RCC_PERIPHCLOCK_ALL                                                                        \
    (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 | RCC_PERIPHCLK_LPUART1 |  \
     RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 | RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_LPTIM1 |         \
     RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_SAI1 | RCC_PERIPHCLK_ADC | RCC_PERIPHCLK_SWPMI1 |        \
...
#define RCC_PERIPHCLOCK_ALL                                                                        \
    (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_LPUART1 | RCC_PERIPHCLK_I2C1 |    \
     RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_SAI1 |       \
     RCC_PERIPHCLK_USB | RCC_PERIPHCLK_ADC | RCC_PERIPHCLK_SWPMI1 | RCC_PERIPHCLK_RTC |            \
     RCC_PERIPHCLK_RNG)
#elif defined(STM32L433xx) || defined(STM32L443xx)
#define RCC_PERIPHCLOCK_ALL                                                                        \
    (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 | RCC_PERIPHCLK_LPUART1 |  \
     RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 | RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_LPTIM1 |         \
     RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_SAI1 | RCC_PERIPHCLK_USB | RCC_PERIPHCLK_ADC |           \
     RCC_PERIPHCLK_SWPMI1 | RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_SDMMC1)
...
#define RCC_PERIPHCLOCK_ALL                                                                        \
    (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 | RCC_PERIPHCLK_UART4 |    \
     ...
     RCC_PERIPHCLK_I2C4 | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_SAI1 |       \
     RCC_PERIPHCLK_ADC | RCC_PERIPHCLK_DFSDM1 | RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_RNG |            \
...
#define RCC_PERIPHCLOCK_ALL                                                                        \
    (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 | RCC_PERIPHCLK_UART4 |    \
     RCC_PERIPHCLK_LPUART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 | RCC_PERIPHCLK_I2C3 |        \
     RCC_PERIPHCLK_I2C4 | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_SAI1 |       \
     RCC_PERIPHCLK_USB | RCC_PERIPHCLK_ADC | RCC_PERIPHCLK_DFSDM1 | RCC_PERIPHCLK_RTC |            \
     RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_SDMMC1)
#elif defined(STM32L471xx)
#define RCC_PERIPHCLOCK_ALL                                                                        \
    (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 | RCC_PERIPHCLK_UART4 |    \
     RCC_PERIPHCLK_UART5 | RCC_PERIPHCLK_LPUART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 |       \
     RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_SAI1 |       \
     RCC_PERIPHCLK_SAI2 | RCC_PERIPHCLK_ADC | RCC_PERIPHCLK_SWPMI1 | RCC_PERIPHCLK_DFSDM1 |        \
     RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_SDMMC1)
#elif defined(STM32L496xx) || defined(STM32L4A6xx)
#define RCC_PERIPHCLOCK_ALL                                                                        \
    (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 | RCC_PERIPHCLK_UART4 |    \
     RCC_PERIPHCLK_UART5 | RCC_PERIPHCLK_LPUART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 |       \
     RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_I2C4 | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 |       \
     RCC_PERIPHCLK_SAI1 | RCC_PERIPHCLK_SAI2 | RCC_PERIPHCLK_USB | RCC_PERIPHCLK_ADC |             \
     RCC_PERIPHCLK_SWPMI1 | RCC_PERIPHCLK_DFSDM1 | RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_RNG |         \
     RCC_PERIPHCLK_SDMMC1)
...
#define RCC_PERIPHCLOCK_ALL                                                                        \
    (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 | RCC_PERIPHCLK_UART4 |    \
     ...
     RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_I2C4 | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 |       \
     RCC_PERIPHCLK_SAI1 | RCC_PERIPHCLK_SAI2 | RCC_PERIPHCLK_USB | RCC_PERIPHCLK_ADC |             \
     RCC_PERIPHCLK_DFSDM1 | RCC_PERIPHCLK_DFSDM1AUDIO | RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_RNG |    \
     RCC_PERIPHCLK_SDMMC1 | RCC_PERIPHCLK_OSPI | RCC_PERIPHCLK_LTDC)
...
#define RCC_PERIPHCLOCK_ALL                                                                        \
    (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 | RCC_PERIPHCLK_UART4 |    \
     ...
     RCC_PERIPHCLK_SAI1 | RCC_PERIPHCLK_SAI2 | RCC_PERIPHCLK_USB | RCC_PERIPHCLK_ADC |             \
     RCC_PERIPHCLK_DFSDM1 | RCC_PERIPHCLK_DFSDM1AUDIO | RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_RNG |    \
     RCC_PERIPHCLK_SDMMC1 | RCC_PERIPHCLK_OSPI | RCC_PERIPHCLK_LTDC | RCC_PERIPHCLK_DSI)
#else
#define RCC_PERIPHCLOCK_ALL                                                                        \
    (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 | RCC_PERIPHCLK_UART4 |    \
     RCC_PERIPHCLK_UART5 | RCC_PERIPHCLK_LPUART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 |       \
     RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_SAI1 |       \
     RCC_PERIPHCLK_SAI2 | RCC_PERIPHCLK_USB | RCC_PERIPHCLK_ADC | RCC_PERIPHCLK_SWPMI1 |           \
...
#define IS_RCC_USART2CLKSOURCE(__SOURCE__)                                                         \
    (((__SOURCE__) == RCC_USART2CLKSOURCE_PCLK1) ||                                                \
     ((__SOURCE__) == RCC_USART2CLKSOURCE_SYSCLK) || ((__SOURCE__) == RCC_USART2CLKSOURCE_LSE) ||  \
...
#define IS_RCC_USART3CLKSOURCE(__SOURCE__)                                                         \
    (((__SOURCE__) == RCC_USART3CLKSOURCE_PCLK1) ||                                                \
     ((__SOURCE__) == RCC_USART3CLKSOURCE_SYSCLK) || ((__SOURCE__) == RCC_USART3CLKSOURCE_LSE) ||  \
...
#define IS_RCC_UART4CLKSOURCE(__SOURCE__)                                                          \
    (((__SOURCE__) == RCC_UART4CLKSOURCE_PCLK1) || ((__SOURCE__) == RCC_UART4CLKSOURCE_SYSCLK) ||  \
     ((__SOURCE__) == RCC_UART4CLKSOURCE_LSE) || ((__SOURCE__) == RCC_UART4CLKSOURCE_HSI))
...
#define IS_RCC_UART5CLKSOURCE(__SOURCE__)                                                          \
    (((__SOURCE__) == RCC_UART5CLKSOURCE_PCLK1) || ((__SOURCE__) == RCC_UART5CLKSOURCE_SYSCLK) ||  \
     ((__SOURCE__) == RCC_UART5CLKSOURCE_LSE) || ((__SOURCE__) == RCC_UART5CLKSOURCE_HSI))
...
#define IS_RCC_I2C3CLKSOURCE(__SOURCE__)                                                           \
    (((__SOURCE__) == RCC_I2C3CLKSOURCE_PCLK1) || ((__SOURCE__) == RCC_I2C3CLKSOURCE_SYSCLK) ||    \
...
#define IS_RCC_SAI1CLK(__SOURCE__)                                                                 \
    (((__SOURCE__) == RCC_SAI1CLKSOURCE_PLLSAI1) || ((__SOURCE__) == RCC_SAI1CLKSOURCE_PLLSAI2) || \
     ((__SOURCE__) == RCC_SAI1CLKSOURCE_PLL) || ((__SOURCE__) == RCC_SAI1CLKSOURCE_PIN) ||         \
...
#define IS_RCC_SAI2CLK(__SOURCE__)                                                                 \
    (((__SOURCE__) == RCC_SAI2CLKSOURCE_PLLSAI1) || ((__SOURCE__) == RCC_SAI2CLKSOURCE_PLLSAI2) || \
     ((__SOURCE__) == RCC_SAI2CLKSOURCE_PLL) || ((__SOURCE__) == RCC_SAI2CLKSOURCE_PIN) ||         \
...
#define IS_RCC_SDMMC1CLKSOURCE(__SOURCE__)                                                         \
    (((__SOURCE__) == RCC_SDMMC1CLKSOURCE_PLLP) || ((__SOURCE__) == RCC_SDMMC1CLKSOURCE_HSI48) ||  \
     ((__SOURCE__) == RCC_SDMMC1CLKSOURCE_PLLSAI1) || ((__SOURCE__) == RCC_SDMMC1CLKSOURCE_PLL) || \
...
#define IS_RCC_RNGCLKSOURCE(__SOURCE__)                                                            \
    (((__SOURCE__) == RCC_RNGCLKSOURCE_HSI48) || ((__SOURCE__) == RCC_RNGCLKSOURCE_PLLSAI1) ||     \
...
#define IS_RCC_RNGCLKSOURCE(__SOURCE__)                                                            \
    (((__SOURCE__) == RCC_RNGCLKSOURCE_NONE) || ((__SOURCE__) == RCC_RNGCLKSOURCE_PLLSAI1) ||      \
     ((__SOURCE__) == RCC_RNGCLKSOURCE_PLL) || ((__SOURCE__) == RCC_RNGCLKSOURCE_MSI))
...
#define IS_RCC_USBCLKSOURCE(__SOURCE__)                                                            \
    (((__SOURCE__) == RCC_USBCLKSOURCE_HSI48) || ((__SOURCE__) == RCC_USBCLKSOURCE_PLLSAI1) ||     \
...
#define IS_RCC_USBCLKSOURCE(__SOURCE__)                                                            \
    (((__SOURCE__) == RCC_USBCLKSOURCE_NONE) || ((__SOURCE__) == RCC_USBCLKSOURCE_PLLSAI1) ||      \
     ((__SOURCE__) == RCC_USBCLKSOURCE_PLL) || ((__SOURCE__) == RCC_USBCLKSOURCE_MSI))
...
#define IS_RCC_ADCCLKSOURCE(__SOURCE__)                                                            \
    (((__SOURCE__) == RCC_ADCCLKSOURCE_NONE) || ((__SOURCE__) == RCC_ADCCLKSOURCE_PLLSAI1) ||      \
     ((__SOURCE__) == RCC_ADCCLKSOURCE_PLLSAI2) || ((__SOURCE__) == RCC_ADCCLKSOURCE_SYSCLK))
...
#else
#define IS_RCC_ADCCLKSOURCE(__SOURCE__)                                                            \
    (((__SOURCE__) == RCC_ADCCLKSOURCE_NONE) || ((__SOURCE__) == RCC_ADCCLKSOURCE_SYSCLK))
#endif /* RCC_PLLSAI1_SUPPORT */
...
#define IS_RCC_DSICLKSOURCE(__SOURCE__)                                                            \
    (((__SOURCE__) == RCC_DSICLKSOURCE_DSIPHY) || ((__SOURCE__) == RCC_DSICLKSOURCE_PLLSAI2))
...
#define IS_RCC_OSPICLKSOURCE(__SOURCE__)                                                           \
    (((__SOURCE__) == RCC_OSPICLKSOURCE_SYSCLK) || ((__SOURCE__) == RCC_OSPICLKSOURCE_MSI) ||      \
