...
#define PCD_SET_EP_RX_ADDRESS(USBx, bEpNum, wAddr)                                                 \
    do {                                                                                           \
        ...
        _wRegBase += (uint32_t)(USBx)->BTABLE;                                                     \
        _wRegVal =                                                                                 \
            (__IO uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)(bEpNum)*8U) + 4U) * PMA_ACCESS)); \
        *_wRegVal = ((wAddr) >> 1) << 1;                                                           \
...
#define PCD_SET_EP_RX_DBUF0_CNT(USBx, bEpNum, wCount)                                              \
    do {                                                                                           \
        ...
        _wRegBase += (uint32_t)(USBx)->BTABLE;                                                     \
        pdwReg =                                                                                   \
            (__IO uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)(bEpNum)*8U) + 2U) * PMA_ACCESS)); \
...
#define PCD_SET_EP_RX_CNT(USBx, bEpNum, wCount)                                                    \
    do {                                                                                           \
        ...
        _wRegBase += (uint32_t)(USBx)->BTABLE;                                                     \
        _wRegVal =                                                                                 \
            (__IO uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)(bEpNum)*8U) + 6U) * PMA_ACCESS)); \
