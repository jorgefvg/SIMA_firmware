...
#define SCB_BASE_NS                                                                                \
    (SCS_BASE_NS + 0x0D00UL) /*!< System Control Block Base Address (non-secure address space) */

#define SCnSCB_NS                                                                                  \
    ((SCnSCB_Type *)                                                                               \
         SCS_BASE_NS) /*!< System control Register not in SCB(non-secure address space) */
#define SCB_NS                                                                                     \
    ((SCB_Type *)SCB_BASE_NS) /*!< SCB configuration struct          (non-secure address space) */
#define SysTick_NS                                                                                 \
    ((SysTick_Type *)                                                                              \
...
#if defined(__MPU_PRESENT) && (__MPU_PRESENT == 1U)
#define MPU_BASE_NS                                                                                \
    (SCS_BASE_NS + 0x0D90UL) /*!< Memory Protection Unit            (non-secure address space) */
#define MPU_NS                                                                                     \
    ((MPU_Type *)MPU_BASE_NS) /*!< Memory Protection Unit            (non-secure address space) */
#endif

#define FPU_BASE_NS                                                                                \
    (SCS_BASE_NS + 0x0F30UL) /*!< Floating Point Unit               (non-secure address space) */
#define FPU_NS                                                                                     \
    ((FPU_Type *)FPU_BASE_NS) /*!< Floating Point Unit               (non-secure address space) */
