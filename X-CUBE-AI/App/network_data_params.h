...
#define AI_NETWORK_DATA_ACTIVATION_1_SIZE (256)

#define AI_NETWORK_DATA_WEIGHTS_SIZES                                                              \
    { 5260, }
#define AI_NETWORK_DATA_WEIGHTS_SIZE            (5260)
#define AI_NETWORK_DATA_WEIGHTS_COUNT           (1)
#define AI_NETWORK_DATA_WEIGHT_1_SIZE           (5260)

#define AI_NETWORK_DATA_ACTIVATIONS_TABLE_GET() (&g_network_activations_table[1])

extern ai_handle g_network_activations_table[1 + 2];

#define AI_NETWORK_DATA_WEIGHTS_TABLE_GET() (&g_network_weights_table[1])
