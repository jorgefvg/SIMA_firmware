...
#define AI_NETWORK_ORIGIN_MODEL_NAME "iris_model"
...
AI_DEPRECATED
#define AI_NETWORK_IN ai_network_inputs_get(AI_HANDLE_NULL, NULL)
...
AI_DEPRECATED
#define AI_NETWORK_OUT ai_network_outputs_get(AI_HANDLE_NULL, NULL)
