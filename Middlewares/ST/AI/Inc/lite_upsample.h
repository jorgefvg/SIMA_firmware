 ...
 */
void forward_lite_upsample_bilinear_if32of32(const ai_float * in_data, ai_float * out_data,
                                             const ai_size width_in, const ai_size height_in,
                                             const ai_float width_scale,
                                             const ai_float height_scale, const ai_size width_out,
                                             const ai_size height_out, const ai_size n_channel,
 ...
 * @param[in] center centered coordinates
 */
void forward_lite_upsample_bilinear_is8os8(const ai_i8 * in_data, ai_i8 * out_data,
                                           const ai_size width_in, const ai_size height_in,
                                           const ai_float width_scale, const ai_float height_scale,
                                           const ai_size width_out, const ai_size height_out,
                                           const ai_size n_channel, const ai_bool center);
 ...
 * @param[in] center centered coordinates
 */
void forward_lite_upsample_bilinear_iu8ou8(const ai_u8 * in_data, ai_u8 * out_data,
                                           const ai_size width_in, const ai_size height_in,
                                           const ai_float width_scale, const ai_float height_scale,
                                           const ai_size width_out, const ai_size height_out,
                                           const ai_size n_channel, const ai_bool center);
 ...
 * @param[in] channel_in input/output channels.
 */
void forward_lite_upsample_bilinear_is16os16(const ai_i16 * in_data, ai_i16 * out_data,
                                             const ai_size width_in, const ai_size height_in,
                                             const ai_float width_scale,
                                             const ai_float height_scale, const ai_size width_out,
                                             const ai_size height_out, const ai_size n_channel,
 ...
 * @param[in] center centered coordinates
 */
void forward_lite_upsample_bilinear_iu16ou16(const ai_u16 * in_data, ai_u16 * out_data,
                                             const ai_size width_in, const ai_size height_in,
                                             const ai_float width_scale,
                                             const ai_float height_scale, const ai_size width_out,
                                             const ai_size height_out, const ai_size n_channel,
 ...
 */
void forward_lite_upsample_zeros_is8os8(const ai_i8 * in_data, ai_i8 * out_data,
                                        const ai_size width_in, const ai_size height_in,
                                        const ai_float width_scale, const ai_float height_scale,
                                        const ai_size width_out, const ai_size height_out,
                                        const ai_size channel_in, const ai_i8 zero_s8);
 ...
 */
void forward_lite_upsample_zeros_is16os16(const ai_i16 * in_data, ai_i16 * out_data,
                                          const ai_size width_in, const ai_size height_in,
                                          const ai_float width_scale, const ai_float height_scale,
                                          const ai_size channel_in, const ai_size width_out,
                                          const ai_size height_out, const ai_i16 zero_s16);
 ...
 * @param[in] channel_in input/output channels.
 */
void forward_lite_upsample_zeros_if32of32(const ai_float * in_data, ai_float * out_data,
                                          const ai_size width_in, const ai_size height_in,
                                          const ai_float width_scale, const ai_float height_scale,
                                          const ai_size channel_in, const ai_size width_out,
