 ...
 */
LITE_API_ENTRY
void forward_lite_dense_is1of32wf32(ai_float * output, const ai_pbits * input,
 ...
 */
LITE_API_ENTRY
void forward_lite_dense_is1of32wf32_bn(ai_float * output, const ai_pbits * input,
                                       const ai_float * weights, const ai_float * scale,
