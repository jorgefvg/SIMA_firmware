 ...
 */
LITE_API_ENTRY
const uint8_t * lite_decompress_ilutof32(float * out, const uint8_t * data0, const float * lut,
                                         const uint16_t lut_bits, const ai_size n_in,
                                         const ai_size n_out);
 ...
 */
LITE_API_ENTRY
void forward_lite_dense_if32of32wf32_lut4(ai_float * output, const ai_float * input,
                                          const ai_u8 * weights_indeces,
                                          const ai_float * weights_lut, ai_float * scratch_lut,
                                          const ai_float * bias, const ai_size n_channel_in,
                                          const ai_size n_channel_out, const ai_size n_elements);
 ...
 */
LITE_API_ENTRY
void forward_lite_dense_if32of32wf32_lut8(ai_float * output, const ai_float * input,
                                          const ai_u8 * weights_indeces,
                                          const ai_float * weights_lut, ai_float * scratch_lut,
                                          const ai_float * bias, const ai_size n_channel_in,
                                          const ai_size n_channel_out, const ai_size n_elements);
