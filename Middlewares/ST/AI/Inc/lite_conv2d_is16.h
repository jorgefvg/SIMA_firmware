 ...
 */
LITE_API_ENTRY
void forward_lite_conv2d_is16os16ws16_fxp(int16_t * output, const int16_t * input,
                                          const int16_t * weights, const int16_t * bias,
                                          ...
                                          const ai_size filt_width, const ai_size filt_height,
                                          const ai_size filt_pad_x, const ai_size filt_pad_y,
                                          const uint16_t stride_x, const uint16_t stride_y,
                                          const uint8_t * shifts, const uint8_t * bias_shifts);
 ...
 */
LITE_API_ENTRY
void forward_lite_conv2d_is16ou16ws16_fxp(uint16_t * output, const int16_t * input,
                                          const int16_t * weights, const int16_t * bias,
                                          const ai_size n_channel_in, const ai_size n_channel_out,
                                          const ai_size width_in, const ai_size height_in,
                                          const ai_size width_out, const ai_size height_out,
 ...
 */
LITE_API_ENTRY
void forward_lite_conv2d_iu16os16ws16_fxp(int16_t * output, const uint16_t * input,
                                          const int16_t * weights, const int16_t * bias,
                                          const ai_size n_channel_in, const ai_size n_channel_out,
                                          const ai_size width_in, const ai_size height_in,
                                          const ai_size width_out, const ai_size height_out,
 ...
 */
LITE_API_ENTRY
void forward_lite_conv2d_iu16ou16ws16_fxp(uint16_t * output, const uint16_t * input,
                                          const int16_t * weights, const int16_t * bias,
                                          const ai_size n_channel_in, const ai_size n_channel_out,
                                          const ai_size width_in, const ai_size height_in,
                                          const ai_size width_out, const ai_size height_out,
