 ...
 */
LITE_API_ENTRY
void forward_lite_norm_if32of32(ai_float * output, const ai_float * input,
                                const ai_u32 ai_lite_norm_type, const ai_float exponent,
                                const ai_size n_axis, const ai_size n_axis_stride,
                                const ai_size n_el, ai_bool scale);
