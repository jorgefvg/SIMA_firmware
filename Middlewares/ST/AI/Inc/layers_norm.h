 ...
 */
AI_INTERNAL_API
void func_lrn_array_f32(ai_handle out, const ai_handle in, const ai_size in_size,
                        const ai_size channel_size, const ai_i32 pad, const ai_float k,
 ...
 */
AI_INTERNAL_API
void func_norm_array_f32(ai_handle out, const ai_handle in, const ai_float exponent,
                         const ai_float norm, const ai_size axis_stride, const ai_size axis_size,
 ...
 */
AI_INTERNAL_API
void func_norm_max_array_f32(ai_handle out, const ai_handle in, const ai_float norm,
                             const ai_size axis_size, const ai_size n_el);
 ...
 */
AI_INTERNAL_API
void func_norm_l2_fast_array_f32(ai_handle out, const ai_handle in, const ai_float norm,
                                 const ai_size axis_size, const ai_size outer_size);
 ...
 */
AI_INTERNAL_API
void func_norm_l1_fast_array_f32(ai_handle out, const ai_handle in, const ai_float norm,
                                 const ai_size axis_size, const ai_size n_el);
