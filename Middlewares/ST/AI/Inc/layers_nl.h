...
typedef void (*func_nl)(ai_tensor * out, const ai_tensor * in, const ai_size size,
                        const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_sm_channel_f32(ai_tensor * out, const ai_tensor * in, const ai_size channel_size,
                            const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_sm_array_f32(ai_tensor * out, ai_tensor * in, const ai_size in_size,
                          const ai_size channel_size, const ai_size in_channel_step,
 ...
 */
AI_INTERNAL_API
void nl_func_sm_zero_channel_f32(ai_tensor * out, const ai_tensor * in, const ai_size channel_size,
                                 const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_probit_f32(ai_tensor * out, const ai_tensor * in, const ai_size channel_size,
                        const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_tanh_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                            const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_tanh_array_fixed(ai_tensor * out, const ai_tensor * in, const ai_size size,
                              const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_sigmoid_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                               const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_sigmoid_array_fixed(ai_tensor * out, const ai_tensor * in, const ai_size size,
                                 const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_hard_sigmoid_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                                    const ai_handle params);
/*!
 ...
 */
AI_INTERNAL_API
void nl_func_logistic_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                                const ai_handle params);
/*!
 ...
 */
AI_INTERNAL_API
void nl_func_swish_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                             const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_hard_swish_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                                  const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_gelu_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                            const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_abs_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                           const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_cos_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                           const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_acos_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                            const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_cosh_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                            const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_acosh_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                             const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_sin_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                           const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_asin_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                            const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_sinh_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                            const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_asinh_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                             const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_tan_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                           const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_atan_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                            const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_atanh_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                             const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_erf_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                           const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_log_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                           const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_rsqrt_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                             const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_square_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                              const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_floor_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                             const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_ceil_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                            const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_round_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                             const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_exp_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                           const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_neg_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                           const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_not_array_bool(ai_tensor * out, const ai_tensor * in, const ai_size size,
                            const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_reciprocal_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                                  const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_sqrt_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                            const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_soft_plus_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                                 const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_soft_sign_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                                 const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_sign_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                            const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_clip_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                            const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_hardmax_array_f32(ai_tensor * out, const ai_tensor * in, const ai_shape * shape,
                               const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_relu_generic_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                                    const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_relu_thresholded_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                                        const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_relu_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                            const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_relu_array_fixed(ai_tensor * out, const ai_tensor * in, const ai_size size,
                              const ai_handle params);
 ...
 * @param params opaque handler to optional nl parameters
 */
void nl_func_relu_array_integer(ai_tensor * out, const ai_tensor * in, const ai_size size,
                                const ai_handle params);
 ...
 * @param params opaque handler to optional nl parameters
 */
void nl_func_clip_array_integer(ai_tensor * out, const ai_tensor * in, const ai_size size,
                                const ai_handle params);
 ...
 */
void nl_func_array_integer(ai_tensor * out, const ai_tensor * in, const ai_size size,
                           const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_elu_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                           const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_relu_max_array_fixed(ai_tensor * out, const ai_tensor * in, const ai_size size,
                                  const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_selu_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                            const ai_handle params);
 ...
 */
AI_INTERNAL_API
void nl_func_prelu_array_f32(ai_tensor * out, const ai_tensor * in, const ai_size size,
                             const ai_handle params);
 ...
 * @param params opaque handler to optional nl parameters
 */
void nl_func_prelu_array_integer(ai_tensor * out, const ai_tensor * in, const ai_size size,
                                 const ai_handle params);
