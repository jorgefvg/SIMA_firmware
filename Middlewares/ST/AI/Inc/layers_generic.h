 ...
 * @ref forward_shape
 */
typedef AI_ALIGNED_TYPE(struct, 4) ai_layer_shape_{AI_LAYER_COMMON_FIELDS_DECLARE} ai_layer_shape;
...
typedef void (*func_buffer_binary)(ai_handle out, const ai_handle a, const ai_handle b,
                                   const ai_size loop);
typedef void (*func_buffer_binary_integer)(ai_handle out, const ai_handle a, const ai_handle b,
                                           const ai_size loop, const ai_handle scale1,
                                           const ai_handle zp1, const ai_handle scale2,
                                           const ai_handle zp2, const ai_handle scaleout,
                                           const ai_handle zpout, const ai_i32 scalar_op);
...
/*!
 * @brief Compute the indices of the max elements of the input tensor's element along the provided
 * axis.
 * @ingroup layers_generic
...
/*!
 * @brief Compute the indices of the min elements of the input tensor's element along the provided
 * axis.
 * @ingroup layers_generic
 * @param layer argminmax layer
 */
