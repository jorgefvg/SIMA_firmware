 ...
 */
LITE_API_ENTRY
void forward_lite_dense_is16os16ws1(ai_i16 * output, const ai_i16 * input, const ai_pbits * weights,
 ...
 */
LITE_API_ENTRY
void forward_lite_dense_is16os16ws1_bn(ai_i16 * output, const ai_i16 * input,
 ...
 */
LITE_API_ENTRY
void forward_lite_dense_if32os1ws1(ai_pbits * output, const ai_float * input,
                                   const ai_pbits * weights, const ai_float * bias,
                                   ai_float * scratch, const ai_u32 n_channel_in,
 ...
 */
LITE_API_ENTRY
void forward_lite_dense_if32of32ws1(ai_float * output, const ai_float * input,
 ...
 */
LITE_API_ENTRY
void forward_lite_dense_if32of32ws1_bn(ai_float * output, const ai_float * input,
                                       const ai_pbits * weights, const ai_float * scale,
                                       const ai_float * offset, ai_float * scratch,
                                       const ai_u32 n_channel_in, const ai_u32 n_channel_out);
