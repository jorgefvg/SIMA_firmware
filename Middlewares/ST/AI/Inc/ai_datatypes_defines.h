...
/******************************************************************************/
#define AI_ASSERT(expr) CORE_ASSERT(expr)
...
// #define AI_FORCE_INLINE             static _Pragma("inline=forced")  // TODO: check this
// definition!
...
#define AI_GET_VERSION_STRING(major, minor, micro)                                                 \
    AI_STRINGIFY_ARG(major) "." AI_STRINGIFY_ARG(minor) "." AI_STRINGIFY_ARG(micro)

#define AI_PACK_TENSORS_PTR(...) AI_PACK(__VA_ARGS__)

#define AI_PACK_INFO(size_)                                                                        \
    (ai_tensor_info[1]) {                                                                          \
        {                                                                                          \
