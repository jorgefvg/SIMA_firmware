 ...
 */
void forward_lite_avepool_is8os8(
    const ai_i8 * pData_in, ai_i8 * pData_out, const ai_u16 dim_im_in_x, const ai_u16 dim_im_in_y,
    ...
    const ai_u16 dim_im_out_x, const ai_u16 dim_im_out_y, const ai_float in_scale,
    const ai_i8 in_zeropoint, const ai_float out_scale, const ai_i8 out_zeropoint);
