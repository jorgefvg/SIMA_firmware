 ...
 */
LITE_API_ENTRY
void forward_lite_bn_is16os1ws16(const ai_i16 * pIn, ai_u32 * pOut_32, const ai_i16 * pThreshold,
                                 const ai_i16 dim_x, const ai_i16 dim_y, const ai_i16 channels_num);
 ...
 */
void forward_lite_bn_is8os8(const ai_i8 * p_in, ai_i8 * p_out, ai_size n_channel_inout,
                            ai_size n_elements, ai_float in_scale, const ai_i32 in_zeropoint,
                            ai_float out_scale, const ai_i32 out_zeropoint,
                            const ai_float * pSc_scale, const ai_i8 * pSc_zeropoint,
                            const ai_i8 * pData_scale, const ai_float * pBias_scale,
                            const ai_i8 * pBias_zeropoint, const ai_i8 * pData_bias,
                            ai_i16 bnl_param_sign, ai_i32 scratch_size, ai_i16 * pBuffer_a);
 ...
 *              out shift: nb channels * sizeof(ai_i16)
 */
void forward_lite_bn_is8os8_ch(const ai_i8 * p_in, ai_i8 * p_out, ai_size n_channel_inout,
                               ai_size n_elements, ai_float in_scale, const ai_i32 in_zeropoint,
                               ai_float out_scale, const ai_i32 out_zeropoint,
                               const ai_float * pSc_scale, const ai_i8 * pSc_zeropoint,
                               const ai_i8 * pData_scale, const ai_float * pBias_scale,
 ...
 *              out shift: nb channels * sizeof(ai_i16)
 */
void forward_lite_bn_iu8ou8(const ai_u8 * p_in, ai_u8 * p_out, ai_size n_channel_inout,
                            ai_size n_elements, ai_float in_scale, const ai_i32 in_zeropoint_32,
                            ai_float out_scale, const ai_i32 out_zeropoint_32,
                            const ai_float * pSc_scale, const ai_i8 * pSc_zeropoint,
                            const ai_i8 * pData_scale, const ai_float * pBias_scale,
                            const ai_i8 * pBias_zeropoint, const ai_i8 * pData_bias,
                            ai_i16 bnl_param_sign, ai_i32 scratch_size, ai_i16 * pBuffer_a);
 ...
 *              out shift: nb channels * sizeof(ai_i16)
 */
void forward_lite_bn_iu8ou8_ch(const ai_u8 * p_in, ai_u8 * p_out, ai_size n_channel_inout,
                               ai_size n_elements, ai_float in_scale, const ai_i32 in_zeropoint,
                               ai_float out_scale, const ai_i32 out_zeropoint,
                               const ai_float * pSc_scale, const ai_i8 * pSc_zeropoint,
                               const ai_i8 * pData_scale, const ai_float * pBias_scale,
