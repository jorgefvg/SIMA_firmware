 ...
 */
LITE_API_ENTRY
void forward_lite_dense_is16os16ws16_fxp(int16_t * output, const int16_t * input,
                                         const int16_t * weights, const int16_t * bias,
                                         const uint32_t n_channel_in, const uint32_t n_channel_out,
...
LITE_API_ENTRY
void forward_lite_dense_is16ou16ws16_fxp(uint16_t * output, const int16_t * input,
                                         const int16_t * weights, const int16_t * bias,
                                         const uint32_t n_channel_in, const uint32_t n_channel_out,
                                         const uint8_t * shifts, const uint8_t * bias_shifts);
 ...
 */
LITE_API_ENTRY
void forward_lite_dense_iu16os16ws16_fxp(int16_t * output, const uint16_t * input,
                                         const int16_t * weights, const int16_t * bias,
                                         const uint32_t n_channel_in, const uint32_t n_channel_out,
                                         const uint8_t * shifts, const uint8_t * bias_shifts);
 ...
 */
LITE_API_ENTRY
void forward_lite_dense_iu16ou16ws16_fxp(uint16_t * output, const uint16_t * input,
                                         const int16_t * weights, const int16_t * bias,
                                         const uint32_t n_channel_in, const uint32_t n_channel_out,
                                         const uint8_t * shifts, const uint8_t * bias_shifts);
