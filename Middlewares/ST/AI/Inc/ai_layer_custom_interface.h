 ...
 */
AI_INTERFACE_TYPE
ai_layer_custom * ai_layer_custom_get(ai_layer * layer);
 ...
 */
AI_INTERFACE_TYPE
void ai_layer_custom_release(ai_layer * layer);
 ...
 */
AI_INTERFACE_TYPE
ai_size ai_layer_get_tensor_in_size(const ai_layer * layer);
 ...
 */
AI_INTERFACE_TYPE
ai_size ai_layer_get_tensor_out_size(const ai_layer * layer);
 ...
 */
AI_INTERFACE_TYPE
ai_size ai_layer_get_tensor_weights_size(const ai_layer * layer);
 ...
 */
AI_INTERFACE_TYPE
ai_tensor * ai_layer_get_tensor_in(const ai_layer * layer, const ai_u16 pos);
 ...
 */
AI_INTERFACE_TYPE
ai_tensor * ai_layer_get_tensor_out(const ai_layer * layer, const ai_u16 pos);
 ...
 */
AI_INTERFACE_TYPE
ai_tensor * ai_layer_get_tensor_weights(const ai_layer * layer, const ai_u16 pos);
 ...
 */
AI_INTERFACE_TYPE
ai_bool ai_tensor_has_intq(const ai_tensor * t);
 ...
 */
AI_INTERFACE_TYPE
ai_tensor_intq_info ai_tensor_get_intq(const ai_tensor * t);
 ...
 */
AI_INTERFACE_TYPE
ai_tensor_format ai_tensor_get_format(const ai_tensor * t);
 ...
 */
AI_INTERFACE_TYPE
ai_size ai_tensor_get_shape_size(const ai_tensor * t);
 ...
 */
AI_INTERFACE_TYPE
ai_shape_dimension ai_tensor_get_shape(const ai_tensor * t, const ai_u16 pos);
 ...
 */
AI_INTERFACE_TYPE
ai_size ai_tensor_get_stride_size(const ai_tensor * t);
 ...
 */
AI_INTERFACE_TYPE
ai_stride_dimension ai_tensor_get_stride(const ai_tensor * t, const ai_u16 pos);
 ...
 */
AI_INTERFACE_TYPE
ai_any_ptr ai_tensor_get_data(const ai_tensor * t);
 ...
 */
AI_INTERFACE_TYPE
ai_size ai_tensor_get_data_size(const ai_tensor * t);
 ...
 */
AI_INTERFACE_TYPE
ai_size ai_tensor_get_data_byte_size(const ai_tensor * t);
