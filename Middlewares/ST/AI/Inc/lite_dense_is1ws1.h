 ...
 */
LITE_API_ENTRY
void forward_lite_dense_is1os1ws1(ai_pbits * output, const ai_pbits * input,
                                  const ai_pbits * weights, const ai_pbits * bias, ai_i32 * scratch,
 ...
 */
LITE_API_ENTRY
void forward_lite_dense_is1os1ws1_bn(ai_pbits * output, const ai_pbits * input,
                                     const ai_pbits * weights, const ai_float * scale,
                                     const ai_float * offset, ai_i32 * scratch,
                                     const ai_u32 n_channel_in, const ai_u32 n_channel_out);
 ...
 */
LITE_API_ENTRY
void forward_lite_dense_is1os16ws1(ai_i16 * output, const ai_pbits * input,
                                   const ai_pbits * weights, const ai_pbits * bias,
                                   ai_i32 * scratch, const ai_u32 n_channel_in,
 ...
 */
LITE_API_ENTRY
void forward_lite_dense_is1os16ws1_bn(ai_i16 * output, const ai_pbits * input,
                                      const ai_pbits * weights, const ai_float * scale,
                                      const ai_float * offset, ai_i32 * scratch,
                                      const ai_u32 n_channel_in, const ai_u32 n_channel_out);
 ...
 */
LITE_API_ENTRY
void forward_lite_dense_is1of32ws1(ai_float * output, const ai_pbits * input,
                                   const ai_pbits * weights, const ai_pbits * bias,
                                   ai_i32 * scratch, const ai_u32 n_channel_in,
                                   const ai_u32 n_channel_out);
...
LITE_API_ENTRY
void forward_lite_dense_is1of32ws1_bn(forward_lite_dense_is1of32ws1_bn_args * args);
